...
# OpenGraph protocol
ogp_site_name = "Inductiva API"
ogp_site_url = "https://inductiva.ai/guides/inductiva-api"
ogp_image = "https://inductiva.ai/builds/inductiva-api/_static/inductiva-social-banner.jpg"

# sitemap.xml
# See https://sphinx-sitemap.readthedocs.io/
language = 'en'
version = 'local'
html_baseurl = 'https://inductiva.ai/guides/inductiva-api'
