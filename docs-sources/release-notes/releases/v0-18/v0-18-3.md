...
**Learn more:** Check out the full list of alerts [here](https://website-staging/inductiva.ai/guides/scale-up/optimize-workflow/alerts-events/alerts.md).
...
**Learn more:** Check out the [tutorial](https://website-staging/inductiva.ai/guides/scale-up/optimize-workflow/alert-events/observer-events) for more details. 
