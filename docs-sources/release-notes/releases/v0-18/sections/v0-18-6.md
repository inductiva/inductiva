...
- Documentation & Resources: New guide to run simple Blender simulation (exclusive to Bring Your Own Software)
...
- **Corrected:** The Terminate Task button was missing from the Console on mobile devices.
