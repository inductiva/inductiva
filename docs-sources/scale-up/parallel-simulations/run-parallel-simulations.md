...
You can customize this using `max_idle_time` parameter in the [`MachineGroup` constructor](https://website-staging.inductiva.ai/guides/how-it-works/machines/computational_resources/machinegroup_class).
