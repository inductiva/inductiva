...
# OpenGraph protocol
ogp_site_name = "Inductiva.AI FreeFEM"
ogp_site_url = "https://inductiva.ai/guides/freefem"
ogp_image = "https://inductiva.ai/builds/freefem/_static/inductiva-social-banner.jpg"

# sitemap.xml
# See https://sphinx-sitemap.readthedocs.io/
language = 'en'
version = 'local'
html_baseurl = 'https://inductiva.ai/guides/freefem'
