    ...
    def html(origin: str) -> nodes.Node:
        ...
        html = f'''
            <div class="cta-bar">
                ...
                <ul id="banner_list_ul">
                    <li class="banner_list_li">Start for free</li>
                    <li class="banner_list_li">No subscription</li>
                    <li class="banner_list_li">No credit card needed</li>
                </ul>
