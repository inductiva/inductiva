...
Follow <a href="https://inductiva.ai/guides/how-it-works/machine_simulation/index">the guide</a> we prepared.
...
If you’re struggling to create and run the python file, take a look at the [Quick Start Guide](https://inductiva.ai/guides/how-it-works/get-started/quick-start-guide)
