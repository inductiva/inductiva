...
from inductiva.machines_catalogue_client.api_response import ApiResponse, T as ApiResponseT
import inductiva.machines_catalogue_client.models
from inductiva.machines_catalogue_client import rest
from inductiva.machines_catalogue_client.exceptions import (
    ApiValueError, ApiException, BadRequestException, UnauthorizedException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(inductiva.machines_catalogue_client.models,
                                klass)
