...
class ActionEmailInfo:
    ...
    def __str__(self):
        return f"ActionEmailInfo(type={self.action_type}, email={self.email_address})"
...
class ActionWebhookInfo:
    ...
    def __str__(self):
        return f"ActionWebhookInfo(type={self.action_type}, webhook={self.webhook_url})"
...
class TriggerTaskInfo:
    ...
    def __str__(self):
        return f"TriggerTaskInfo(type={self.trigger_type}, task_id={self.task_id})"
...
class TriggerMachineGroupInfo:
    ...
    def __str__(self):
        return f"TriggerMachineGroupInfo(type={self.trigger_type}, machine_group_id={self.machine_group_id})"
