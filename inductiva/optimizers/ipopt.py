"""Class to run IPOPT jobs on the API."""
from typing import Optional, Sequence, Union

from inductiva import simulators, types


class Ipopt(simulators.Simulator):
    """Class to invoke any IPOPT command on the API."""
    ...
    def __init__(
        ...
        """Initialize the IPOPT optimizer.

        Args:
            version (str): The version of the optimizer to use. If None, the
                latest available version in the platform is used.
            use_dev (bool): Request use of the development version of
                the optimizer. By default (False), the production version
                is used.
        """
        super().__init__(version=version, use_dev=use_dev)
        self.simulator = "arbitrary_commands"
        self.simulator_name_alias = "ipopt"
    ...
    def run(
        ...
        **kwargs,
        ...
        """Run the IPOPT optimizer.

        Args:
            input_dir: Path to the directory of the optimizer input files.
            on: The computational resource to launch the optimizer on.
