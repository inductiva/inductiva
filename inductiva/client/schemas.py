...
from inductiva.client.configuration import (
    Configuration,)
...
class Schema:
    ...
    def _get_new_instance_without_conversion_oapg(
        cls, arg: typing.Any, path_to_item: typing.Tuple[typing.Union[str, int],
                                                         ...],
    ...
    def __new__(cls,
                ...
                **kwargs: typing.Union[dict, frozendict.frozendict, list, tuple,
                                       decimal.Decimal, float, int, str, date,
                                       datetime, bool, None, 'Schema', Unset]):
        """
        Schema __new__
...
class StrBase(ValidatorBase):
    ...
    def __check_str_validations(cls, arg: str,
        ...
        if (cls._is_json_validation_enabled_oapg(
                'maxLength', validation_metadata.configuration) and
        ...
        if (cls._is_json_validation_enabled_oapg(
                'minLength', validation_metadata.configuration) and
        ...
        if (cls._is_json_validation_enabled_oapg(
                'pattern', validation_metadata.configuration) and
...
class NumberBase(ValidatorBase):
    ...
    def __check_numeric_validations(cls, arg,
        ...
        if (cls._is_json_validation_enabled_oapg(
                'exclusiveMaximum', validation_metadata.configuration) and
        ...
        if (cls._is_json_validation_enabled_oapg(
                'maximum', validation_metadata.configuration) and
        ...
        if (cls._is_json_validation_enabled_oapg(
                'exclusiveMinimum', validation_metadata.configuration) and
        ...
        if (cls._is_json_validation_enabled_oapg(
                'minimum', validation_metadata.configuration) and
...
class ListBase(ValidatorBase):
    ...
    def __check_tuple_validations(cls, arg,
        ...
        if not hasattr(cls, 'MetaOapg'):
            return
        if (cls._is_json_validation_enabled_oapg(
                'maxItems', validation_metadata.configuration) and
        ...
        if (cls._is_json_validation_enabled_oapg(
                'minItems', validation_metadata.configuration) and
        ...
        if (cls._is_json_validation_enabled_oapg(
                'uniqueItems', validation_metadata.configuration) and
                hasattr(cls.MetaOapg, 'unique_items') and
                cls.MetaOapg.unique_items and arg):
...
class DictBase(Discriminable, ValidatorBase):
    ...
    def __validate_arg_presence(cls, arg):
        ...
        if invalid_arguments:
            ...
            raise ApiTypeError("{} was passed {} invalid argument{}: {}".format(
                cls.__name__, len(invalid_arguments),
                "s" if len(invalid_arguments) > 1 else "", invalid_arguments))
        ...
        for property_name, value in arg.items():
            ...
            if property_name in property_annotations:
                ...
                raise ApiTypeError(
                    ...
                    .format(value, cls, validation_metadata.path_to_item +
                            (property_name,)))
    ...
    def __check_dict_validations(cls, arg,
        ...
        if not hasattr(cls, 'MetaOapg'):
            return
        if (cls._is_json_validation_enabled_oapg(
                'maxProperties', validation_metadata.configuration) and
        ...
        if (cls._is_json_validation_enabled_oapg(
                'minProperties', validation_metadata.configuration) and
...
class AnyTypeSchema(DictBase, ListBase, NumberBase, StrBase, BoolBase, NoneBase,
                    Schema, NoneFrozenDictTupleStrDecimalBoolFileBytesMixin):
...
class DictSchema(DictBase, Schema, FrozenDictMixin):
    ...
    def __new__(cls, *_args: typing.Union[dict, frozendict.frozendict],
                **kwargs: typing.Union[dict, frozendict.frozendict, list, tuple,
                                       decimal.Decimal, float, int, str, date,
                                       datetime, bool, None, bytes, Schema,
                                       Unset, ValidationMetadata]):
