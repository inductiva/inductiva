...
class Executer(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uuid", "cpu_count_logical", "cpu_count_physical", "memory", "n_mpi_hosts", "vm_type", "vm_name", "host_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uuid", "cpu_count_logical", "cpu_count_physical", "memory", "n_mpi_hosts", "vm_type", "vm_name", "host_type", ], str]):
