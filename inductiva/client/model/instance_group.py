...
class InstanceGroup(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["terminate_time"]
    ) -> MetaOapg.properties.terminate_time:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["terminate_time"]
    ) -> typing.Union[MetaOapg.properties.terminate_time, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        create_time: typing.Union[MetaOapg.properties.create_time, dict,
                                  ...
                                  io.BufferedReader,
                                  schemas.Unset] = schemas.unset,
        terminate_time: typing.Union[MetaOapg.properties.terminate_time, dict,
                                     frozendict.frozendict, str, date, datetime,
