...
class TaskMetrics(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total_seconds", "queue_time_seconds", "computation_seconds", "input_upload_seconds", "input_download_seconds", "input_size_bytes", "input_decompression_seconds", "container_image_download_seconds", "output_compression_seconds", "output_size_bytes", "output_upload_seconds", ], str]):
