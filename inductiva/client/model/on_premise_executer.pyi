...
class OnPremiseExecuter(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "cpu_count_logical", "cpu_count_physical", "memory", "cpu_info", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "cpu_count_logical", "cpu_count_physical", "memory", "cpu_info", "id", ], str]):
