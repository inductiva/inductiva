...
class TierFullInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class quotas(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TierQuotaDetail'], typing.List['TierQuotaDetail']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'quotas':
                    return super().__new__(
                        cls,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "label", "begin_date", "end_date", "capabilities", "quotas", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "label", "begin_date", "end_date", "capabilities", "quotas", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        capabilities: typing.Union[MetaOapg.properties.capabilities, list, tuple, ],
        quotas: typing.Union[MetaOapg.properties.quotas, list, tuple, ],
