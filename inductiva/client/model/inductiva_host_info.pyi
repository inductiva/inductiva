...
class InductivaHostInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["host_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["host_type", ], str]):
