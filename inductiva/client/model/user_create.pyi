...
information on the issue), will only be adressed in Pydantic's version 2.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["username", "api_key", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["username", "api_key", ], str]):
