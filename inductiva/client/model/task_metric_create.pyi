...
class TaskMetricCreate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["metric", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["metric", "value", ], str]):
