...
class TaskMetricCreate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["metric", "value", "timestamp", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["metric", "value", "timestamp", ], str]):
