...
class DefaultMachineGroup(
    ...
    Schema for getting and setting default machine groups.
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "provider_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "provider_id", ], str]):
