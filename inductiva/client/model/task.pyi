...
class Task(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["task_id", "status", "method_name", "executer", "create_time", "input_submit_time", "start_time", "end_time", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["task_id", "status", "method_name", "executer", "create_time", "input_submit_time", "start_time", "end_time", ], str]):
