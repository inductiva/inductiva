...
class Task(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["task_id", "status", "method_name", "create_time", "input_submit_time", "start_time", "end_time", "executer", "storage_path_prefix", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["task_id", "status", "method_name", "create_time", "input_submit_time", "start_time", "end_time", "executer", "storage_path_prefix", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        storage_path_prefix: typing.Union[MetaOapg.properties.storage_path_prefix, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Task':
        return super().__new__(
