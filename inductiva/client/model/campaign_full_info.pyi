...
class CampaignFullInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class quotas(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['CampaignQuotaDetail'], typing.List['CampaignQuotaDetail']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'quotas':
                    return super().__new__(
                        cls,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "label", "credits", "begin_date", "end_date", "capabilities", "quotas", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "label", "credits", "begin_date", "end_date", "capabilities", "quotas", ], str]):
        return super().get_item_oapg(name)
