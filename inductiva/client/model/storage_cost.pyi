...
class StorageCost(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["estimated_monthly_cost"]
    ) -> MetaOapg.properties.estimated_monthly_cost:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        estimated_monthly_cost: typing.Union[
            MetaOapg.properties.estimated_monthly_cost,
            decimal.Decimal,
            int,
            float,
