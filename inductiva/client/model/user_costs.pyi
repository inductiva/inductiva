...
class UserCosts(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class costs(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['UserCostsDetail'], typing.List['UserCostsDetail']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["credits", "costs", "currency", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["credits", "costs", "currency", ], str]):
