...
class ExecuterCreate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["create_time", "cpu_count_logical", "cpu_count_physical", "memory", "cpu_info", "host_info", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["create_time", "cpu_count_logical", "cpu_count_physical", "memory", "cpu_info", "host_info", ], str]):
