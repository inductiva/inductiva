...
class CampaignUsersUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["campaign_id", "emails", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["campaign_id", "emails", ], str]):
