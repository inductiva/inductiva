...
class StorageFileInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["size_bytes", "creation_time", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["size_bytes", "creation_time", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        creation_time: typing.Union[MetaOapg.properties.creation_time, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'StorageFileInfo':
        return super().__new__(
