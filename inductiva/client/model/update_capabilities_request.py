...
class UpdateCapabilitiesRequest(schemas.DictSchema):
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["action"]
    ) -> typing.Union[MetaOapg.properties.action, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        action: typing.Union[MetaOapg.properties.action, dict,
