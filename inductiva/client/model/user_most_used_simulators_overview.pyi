...
class UserMostUsedSimulatorsOverview(
    schemas.DictSchema
):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["success_rate_percentage"]) -> MetaOapg.properties.success_rate_percentage: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["success_rate_percentage"]) -> MetaOapg.properties.success_rate_percentage: ...
