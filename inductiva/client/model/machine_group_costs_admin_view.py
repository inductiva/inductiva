...
class MachineGroupCostsAdminView(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            estimated_cost = schemas.NumberSchema
    ...
    estimated_cost: MetaOapg.properties.estimated_cost

    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["estimated_cost"]
    ) -> MetaOapg.properties.estimated_cost:
        ...
