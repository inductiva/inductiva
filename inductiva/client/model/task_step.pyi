...
class TaskStep(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "start_timestamp", "duration", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "start_timestamp", "duration", ], str]):
