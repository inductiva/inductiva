...
class TaskWithUserInfo(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user"]) -> 'Username': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["task_id", "status", "method_name", "user", "create_time", "input_submit_time", "start_time", "end_time", "executer", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user"]) -> 'Username': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["task_id", "status", "method_name", "user", "create_time", "input_submit_time", "start_time", "end_time", "executer", ], str]):
