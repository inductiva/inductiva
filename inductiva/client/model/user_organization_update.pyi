...
class UserOrganizationUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["organization_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["organization_id", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        organization_id: typing.Union[MetaOapg.properties.organization_id, str, ],
