...
class TaskRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["method", "params", "resource_pool", "client_version", "scenario_name", "storage_path_prefix", "provider_id", "project", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["method", "params", "resource_pool", "client_version", "scenario_name", "storage_path_prefix", "provider_id", "project", ], str]):
