...
class UserMostUsedMachineTypesOverview(
    schemas.DictSchema
):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["num_of_machines_used"]) -> MetaOapg.properties.num_of_machines_used: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["num_tasks"]) -> MetaOapg.properties.num_tasks: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["spot_machines"]) -> MetaOapg.properties.spot_machines: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["preempted_machines"]) -> MetaOapg.properties.preempted_machines: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["machine_type", "num_of_machines_used", "num_tasks", "spot_machines", "preempted_machines", "errors", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["num_of_machines_used"]) -> MetaOapg.properties.num_of_machines_used: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["num_tasks"]) -> MetaOapg.properties.num_tasks: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["spot_machines"]) -> MetaOapg.properties.spot_machines: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["preempted_machines"]) -> MetaOapg.properties.preempted_machines: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["machine_type", "num_of_machines_used", "num_tasks", "spot_machines", "preempted_machines", "errors", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        preempted_machines: typing.Union[MetaOapg.properties.preempted_machines, decimal.Decimal, int, ],
        num_of_machines_used: typing.Union[MetaOapg.properties.num_of_machines_used, decimal.Decimal, int, ],
        spot_machines: typing.Union[MetaOapg.properties.spot_machines, decimal.Decimal, int, ],
