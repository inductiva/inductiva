...
class GCloudExecuter(
    ...
    The read schema of the executer includes our internal id.
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "vm_type", "vm_name", "vm_id", "preemptible", "vm_metadata", "cpu_count_logical", "cpu_count_physical", "memory", "cpu_info", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "vm_type", "vm_name", "vm_id", "preemptible", "vm_metadata", "cpu_count_logical", "cpu_count_physical", "memory", "cpu_info", "id", ], str]):
