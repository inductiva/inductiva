...
class TaskPositionInQueue(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tasks_ahead", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tasks_ahead", ], str]):
