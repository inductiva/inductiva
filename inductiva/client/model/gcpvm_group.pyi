...
class GCPVMGroup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["machine_type", "disk_size_gb", "num_vms", "spot", "is_elastic", "id", "name", "vcpus_per_core", "creation_timestamp", "deletion_timestamp", "type", "min_vms", "max_vms", "provider", "base_image", "use_placement_group", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["machine_type", "disk_size_gb", "num_vms", "spot", "is_elastic", "id", "name", "vcpus_per_core", "creation_timestamp", "deletion_timestamp", "type", "min_vms", "max_vms", "provider", "base_image", "use_placement_group", ], str]):
