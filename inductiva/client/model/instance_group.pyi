...
class InstanceGroup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "machine_type", "spot", "disk_size_gb", "num_instances", "zone", "resource_pool_id", "label", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "machine_type", "spot", "disk_size_gb", "num_instances", "zone", "resource_pool_id", "label", ], str]):
