...
class Quota(BaseModel):
    ...
    id: StrictStr
    label: StrictStr
    max_allowed: Optional[StrictStr] = None
    in_use: Optional[StrictStr] = None
    unit: StrictStr
    scope: QuotaScope
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.max_allowed is None and "max_allowed" in self.model_fields_set:
            _dict['max_allowed'] = None

        # set to None if in_use (nullable) is None
        # and model_fields_set contains the field
        if self.in_use is None and "in_use" in self.model_fields_set:
            _dict['in_use'] = None
