...
class DynamicDiskResizeConfig(BaseModel):
  ...
  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DynamicDiskResizeConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DynamicDiskResizeConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "free_space_threshold_gb": obj.get("free_space_threshold_gb"),
