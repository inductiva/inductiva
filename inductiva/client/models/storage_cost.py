...
class StorageCost(BaseModel):
  ...
  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StorageCost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StorageCost from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "estimated_monthly_cost": obj.get("estimated_monthly_cost"),
