...
class TaskMachineOperation(BaseModel):
    """
    ...
    info: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["machine_id", "type", "start_timestamp", "end_timestamp", "description", "info"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaskMachineOperation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaskMachineOperation from a dict"""
        if obj is None:
            return None
