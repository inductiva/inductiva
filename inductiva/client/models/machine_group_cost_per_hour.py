...
class MachineGroupCostPerHour(BaseModel):
  ...
  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MachineGroupCostPerHour from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MachineGroupCostPerHour from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "min_reason": obj.get("min_reason"),
            "max_reason": obj.get("max_reason"),
