...
class MachineGroupWithCostsAdminView(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MachineGroupWithCostsAdminView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MachineGroupWithCostsAdminView from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "costs": MachineGroupCostsAdminView.from_dict(obj["costs"]) if obj.get("costs") is not None else None,
            "user": UserEmailOrganization.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
