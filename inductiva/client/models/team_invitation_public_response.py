...
class TeamInvitationPublicResponse(BaseModel):
    """
    Schema for team invitation response (public endpoints - no sensitive data).
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = [
        "email", "role", "message", "id", "status", "invited_at", "expires_at",
        "accepted_at", "rejected_at", "invited_by_name", "organization_name"
    ]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TeamInvitationPublicResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TeamInvitationPublicResponse from a dict"""
        if obj is None:
            return None
