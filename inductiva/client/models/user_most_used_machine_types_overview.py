...
class UserMostUsedMachineTypesOverview(BaseModel):
  ...
  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserMostUsedMachineTypesOverview from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserMostUsedMachineTypesOverview from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "num_of_machines_used": obj.get("num_of_machines_used"),
            "num_tasks": obj.get("num_tasks"),
            "spot_machines": obj.get("spot_machines"),
            "preempted_machines": obj.get("preempted_machines"),
