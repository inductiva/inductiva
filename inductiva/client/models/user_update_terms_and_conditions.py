...
class UserUpdateTermsAndConditions(BaseModel):
  ...
  # noqa: E501
    ...
    @field_validator('terms_and_conditions_decision')
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserUpdateTermsAndConditions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserUpdateTermsAndConditions from a dict"""
        if obj is None:
            return None
