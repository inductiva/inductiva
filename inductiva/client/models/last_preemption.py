...
class LastPreemption(BaseModel):
    """
    LastPreemption
    """
  ...
  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["machine_type", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LastPreemption from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LastPreemption from a dict"""
        if obj is None:
            return None
