...
class SimulatorUpdate(BaseModel):
  ...
  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimulatorUpdate from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if processor_type (nullable) is None
        # and model_fields_set contains the field
        if self.processor_type is None and "processor_type" in self.model_fields_set:
            _dict['processor_type'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimulatorUpdate from a dict"""
        if obj is None:
            return None
