...
class Spot1(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = Spot1.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in Spot1 with anyOf schemas: bool, str. Details: "
                + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into Spot1 with anyOf schemas: bool, str. Details: "
                + ", ".join(error_messages))
        else:
            return instance
