...
class Action(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into ActionEmailCreate
        try:
            instance.actual_instance = ActionEmailCreate.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into ActionWebhookCreate
        try:
            instance.actual_instance = ActionWebhookCreate.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
