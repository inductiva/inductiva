...
from inductiva.client.exceptions import ApiTypeError, ApiValueError
from inductiva.client.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ParameterSerializerBase:
    ...
    def _ref6570_expansion(
        ...
        if type(in_data) in {str, float, int}:
            ...
            return cls.__ref6570_list_expansion(variable_name, in_data, explode,
                                                percent_encode,
                                                prefix_separator_iterator,
                                                var_name_piece,
                                                named_parameter_expansion)
        elif isinstance(in_data, dict):
            return cls.__ref6570_dict_expansion(variable_name, in_data, explode,
                                                percent_encode,
                                                prefix_separator_iterator,
                                                var_name_piece,
                                                named_parameter_expansion)
...
class ParameterBase(JSONDetector):
    ...
    def _serialize_json(self,
                        in_data: typing.Union[None, int, float, str, bool, dict,
                                              list],
