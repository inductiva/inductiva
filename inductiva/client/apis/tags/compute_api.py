...
from inductiva.client.paths.compute_group_machine.delete import DeleteSingleVm
...
from inductiva.client.paths.compute_group_mg_id.patch import UpdateVmGroupConfig
