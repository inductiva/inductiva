...
from inductiva.client.paths.gcp_instances_group_resource_pool_id.get import GetInstanceGroup
from inductiva.client.paths.gcp_instances_price.get import GetInstancePrice
from inductiva.client.paths.gcp_instances_storage.get import GetStorageAlloc
