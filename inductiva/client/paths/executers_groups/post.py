...
SchemaFor201ResponseBodyApplicationJson = MachineGroupID
...
class BaseApi(api_client.Api):
    ...
    @typing.overload
    def _create_machine_group_oapg(
        self,
...
class CreateMachineGroup(BaseApi):
    ...
    def create_machine_group(
        ...
        return self._create_machine_group_oapg(
