...
class SchemaFor200ResponseBodyApplicationJson(schemas.ListSchema):
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['InstanceGroup'],
                           typing.List['InstanceGroup']],
...
class BaseApi(api_client.Api):
    ...
    @typing.overload
    def _list_active_user_instance_groups_oapg(
        self,
...
class ListActiveUserInstanceGroups(BaseApi):
    ...
    def list_active_user_instance_groups(
        ...
        return self._list_active_user_instance_groups_oapg(
