...
class PathValues(str, enum.Enum):
    ...
    STORAGE_FOLDER_NAME_INPUT = "/storage/{folder_name}/input"
    STORAGE_FOLDER_NAME_INPUT_URL = "/storage/{folder_name}/input_url"
    STORAGE_FOLDER_NAME_INPUT_NOTIFY = "/storage/{folder_name}/input_notify"
    STORAGE_FOLDER_NAME_INPUT_REMOTE = "/storage/{folder_name}/input_remote"
    STORAGE_FOLDER_NAME = "/storage/{folder_name}"
    VERSION = "/version"
