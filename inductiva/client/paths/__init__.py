...
class PathValues(str, enum.Enum):
    ...
    EXECUTERTRACKER_ID_TASK = "/executer-tracker/{id}/task"
    EXECUTERTRACKER_ID_TASK_TASK_ID_ACK = "/executer-tracker/{id}/task/{task_id}/ack"
    EXECUTERTRACKER_ID_TASK_TASK_ID_MESSAGE = "/executer-tracker/{id}/task/{task_id}/message"
    EXECUTERTRACKER_ID_TASK_TASK_ID_MESSAGE_UNBLOCK = "/executer-tracker/{id}/task/{task_id}/message/unblock"
    EXECUTERTRACKER_ID_EVENT = "/executer-tracker/{id}/event"
