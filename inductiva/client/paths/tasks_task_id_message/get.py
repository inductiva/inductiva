...
request_query_client = api_client.QueryParameter(
    name="client",
...
request_query_block_s = api_client.QueryParameter(
    name="block_s",
    style=api_client.ParameterStyle.FORM,
    schema=BlockSSchema,
    explode=True,
...
class BaseApi(api_client.Api):
    ...
    def _get_message_oapg(
        ...
        for parameter in (
                request_query_client,
                request_query_block_s,
        ):
...
class GetMessage(BaseApi):
    ...
    def get_message(
        ...
        return self._get_message_oapg(query_params=query_params,
