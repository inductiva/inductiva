...
# Query params
RegenerateSchema = schemas.BoolSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams', {
        'regenerate': typing.Union[
            RegenerateSchema,
            bool,
        ],
    })
...
request_query_regenerate = api_client.QueryParameter(
    name="regenerate",
...
SchemaFor200ResponseBodyApplicationJson = UserApiKey
...
class BaseApi(api_client.Api):
    ...
    def _get_api_key_oapg(
        ...
        _path_params = {}
        for parameter in (request_path_email,):
        ...
        for parameter in (request_query_regenerate,):
...
class GetApiKey(BaseApi):
    ...
    def get_api_key(
        ...
        return self._get_api_key_oapg(query_params=query_params,
