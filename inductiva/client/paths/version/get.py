...
SchemaFor200ResponseBodyApplicationJson = BackendVersion
...
class GetBackendVersion(BaseApi):
    ...
    def get_backend_version(
        ...
        return self._get_backend_version_oapg(
