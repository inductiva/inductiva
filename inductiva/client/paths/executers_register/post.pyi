...
# body param
SchemaForRequestBodyApplicationJson = ExecuterInfo


request_body_executer_info = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _register_executer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_executer_info.serialize(body, content_type)
