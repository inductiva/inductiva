...
class UsernameSchema(schemas.ListSchema):
...
class MethodSchema(schemas.ListSchema):
...
class StatusSchema(schemas.ListSchema):

    class MetaOapg:

        @staticmethod
        def items() -> typing.Type['TaskStatusCode']:
            return TaskStatusCode

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['TaskStatusCode'],
                           typing.List['TaskStatusCode']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'StatusSchema':
        return super().__new__(
            cls,
    ...
    def __getitem__(self, i: int) -> 'TaskStatusCode':
        return super().__getitem__(i)
...
class SchemaFor200ResponseBodyApplicationJson(schemas.ListSchema):
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TaskWithUsername']:
            return TaskWithUsername

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['TaskWithUsername'],
                           typing.List['TaskWithUsername']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'TaskWithUsername':
        return super().__getitem__(i)
...
class GetTasks(BaseApi):
    ...
    def get_tasks(
        ...
        return self._get_tasks_oapg(query_params=query_params,
