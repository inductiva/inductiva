...
class BaseApi(api_client.Api):
    ...
    @typing.overload
    def _start_elastic_instance_group_oapg(
        self,
        body: typing.Union[
...
class StartElasticInstanceGroup(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def start_elastic_instance_group(
        self,
        body: typing.Union[
            SchemaForRequestBodyApplicationJson,
        ],
    ...
    def start_elastic_instance_group(
        ...
        return self._start_elastic_instance_group_oapg(
            body=body,
