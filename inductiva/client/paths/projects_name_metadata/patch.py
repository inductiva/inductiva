...
class BaseApi(api_client.Api):
    ...
    @typing.overload
    def _update_project_metadata_oapg(
        self,
        body: typing.Union[
            SchemaForRequestBodyApplicationJson,
            dict,
    ...
    def _update_project_metadata_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_request_body.serialize(
            body, content_type)
...
class UpdateProjectMetadata(BaseApi):
    ...
    def update_project_metadata(
        ...
        return self._update_project_metadata_oapg(
            body=body,
