...
class SchemaFor200ResponseBodyApplicationJson(schemas.ListSchema):
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['StorageOperation']:
            return StorageOperation

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['StorageOperation'],
                           typing.List['StorageOperation']],
    ...
    def __getitem__(self, i: int) -> 'StorageOperation':
...
class BaseApi(api_client.Api):
    ...
    @typing.overload
    def _get_operations_by_user_oapg(
        self,
...
class GetOperationsByUser(BaseApi):
    ...
    def get_operations_by_user(
        ...
        return self._get_operations_by_user_oapg(
