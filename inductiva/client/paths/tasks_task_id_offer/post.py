...
# body param
SchemaForRequestBodyApplicationJson = TaskConnection

request_body_task_connection = api_client.RequestBody(
    content={
        'application/json':
...
class BaseApi(api_client.Api):
    ...
    def _offer_task_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_task_connection.serialize(
            body, content_type)
...
class OfferTask(BaseApi):
    ...
    def offer_task(
        ...
        return self._offer_task_oapg(body=body,
