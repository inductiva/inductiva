...
class StorageApi:
    ...
    def get_zip_file_range(
        ...
        Return the byte range (start and end) of the compressed data for a specific file inside a ZIP.
        ...
        _param = self._get_zip_file_range_serialize(
            filename=filename,
            zip_relative_path=zip_relative_path,
            path=path,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_zip_file_range_with_http_info(
        self,
        filename: StrictStr,
        zip_relative_path: Optional[StrictStr] = None,
        path: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_zip_file_range_without_preload_content(
        self,
        filename: StrictStr,
        zip_relative_path: Optional[StrictStr] = None,
        path: Optional[StrictStr] = None,
    ...
    def _get_zip_file_range_serialize(
        self,
        filename,
        zip_relative_path,
        path,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/storage/zip-file-range',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
