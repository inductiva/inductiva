...
class WindTunnel(scenarios.Scenario):
    ...
    def set_default_output_files(self):
        """Set default files generated by backend post-processing."""

        return [
            "pressure_field.vtk", "streamlines.vtk", "vertical_slice_0.vtk",
            "vertical_slice_1.vtk", "vertical_slice_2.vtk",
            "force_coefficients.csv", "stderr.txt", "stdout.txt",
            "horizontal_slice.vtk"
        ]
