...
class WindTunnel(Scenario):
    ...
    def set_default_output_files(self):
        ...
        return [
            "pressure_field.vtk", "streamlines.vtk",
            "vertical_slice_0.vtk", "vertical_slice_1.vtk",
            "vertical_slice_2.vtk", "force_coefficients.csv", "stderr.txt",
            "stdout.txt", "horizontal_slice.vtk"
        ]
