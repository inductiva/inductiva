    ...
    def __init__(
        ...
        Args:
            ...
            auto_terminate_minutes: Duration, in minutes, the MachineGroup will
                ...
                resource or not). This differs from `max_idle_time`, which
                terminates the MachineGroup only after it has been idle for a
                specified duration. Use `auto_terminate_minutes` to enforce a
                strict time limit, while `max_idle_time` is better suited for
                terminating the MachineGroup when it is no longer actively
                processing tasks.  
