"""FreeFEM module of the API for simulations."""
...
class FreeFEM(simulators.Simulator):
    """Class to invoke a generic FreeFEM simulation on the API.
    """

    def __init__(self, /, version: Optional[str] = None, use_dev: bool = False):
        """Initialize the FreeFEM simulator.
        ...
        self.simulator_name_alias = "freefem"
    ...
    def run(self,
        ...
        Args:
            ...
            commands: List of commands to run using the FreeFEM simulator.
