...
def test_benchmark_run(benchmark, num_repeats, wait_for_quotas):
    ...
    simulator_run_calls = [
        mock.call(input_dir="dir", on=m4, a=1, b=1, project_name="test_benchmark"),
        mock.call(input_dir="dir", on=m4, a=1, b=4, project_name="test_benchmark"),
        mock.call(input_dir="dir", on=m8, a=1, b=8, project_name="test_benchmark"),
    ] * num_repeats
