...
````{eval-rst}
.. seealso::
   Learn more about how `tasks <https://inductiva-research-labs-inductiva--1143.com.readthedocs.build/en/1143/explore_api/tasks.html>`_ are generated through the Inductiva API.
````
